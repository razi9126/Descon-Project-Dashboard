...
# Read the data file
ot = pd.read_excel("./data/Craftwise_Overtime.xlsx")
...
with open('./data/craftwise_overtime_indirect.pickle', 'wb') as handle:
...
# Store data (serialize)
with open('./data/craftwise_overtime_direct.pickle', 'wb') as handle:
    pickle.dump(dict, handle, protocol=pickle.HIGHEST_PROTOCOL)
